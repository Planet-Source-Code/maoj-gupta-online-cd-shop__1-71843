...
<div id="wrapper">
  ...
  <li><a href="cd_music.asp">Category +</a>
    <ul>
      <li><a href="cd_music.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      <%
           ...
           rec.Open "Select * from [Disc] where Category='Music' AND Type='CD'",conn
           if rec.EOF Then
