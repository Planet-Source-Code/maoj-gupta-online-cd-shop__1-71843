...
<div id="wrapper">
  ...
  <li><a href="dvd_movie.asp">Category +</a>
    <ul>
      <li><a href="dvd_movie.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      <%
           ...
           rec.Open "Select * from [Disc] where Category='Movie' AND Type='DVD'",conn
           if rec.EOF Then
