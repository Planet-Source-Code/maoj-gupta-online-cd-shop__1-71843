...
<div id="wrapper">
  ...
  <li><a href="cd_movie.asp">Category +</a>
    <ul>
      <li><a href="cd_movie.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      <%
           ...
           rec.Open "Select * from [Disc] where Category='Movie' AND Type='CD'",conn
           if rec.EOF Then
