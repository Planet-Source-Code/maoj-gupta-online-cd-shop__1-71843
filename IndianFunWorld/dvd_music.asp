...
<div id="wrapper">
  ...
  <li><a href="dvd_music.asp">Category +</a>
    <ul>
      <li><a href="dvd_music.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      <%
           ...
           rec.Open "Select * from [Disc] where Category='Music' AND Type='DVD'",conn
           if rec.EOF Then
