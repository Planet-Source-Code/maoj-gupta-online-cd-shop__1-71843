...
<div id="wrapper">
  ...
  <li><a href="dvd_game.asp">Category +</a>
    <ul>
      <li><a href="dvd_game.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      <%
           ...
           rec.Open "Select * from [Disc] where Category='Game' AND Type='DVD'",conn
           if rec.EOF Then
