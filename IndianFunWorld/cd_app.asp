...
<div id="wrapper">
  ...
  <li><a href="cd_app.asp">Category +</a>
    <ul>
      <li><a href="cd_app.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      <%
           ...
           rec.Open "Select * from [Disc] where Category='Application' AND Type='CD'",conn
