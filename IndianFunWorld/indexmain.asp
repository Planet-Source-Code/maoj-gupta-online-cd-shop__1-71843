...
<div id="wrapper">
  ...
  <li><a href="indexmain.asp">Category +</a>
    <ul>
      <li><a href="indexmain.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      <%
           ...
           if rec.EOF Then
                response.write"<h3>No Item Found <br><br><a href=indexmain.asp>Click Here to return on Index Page</a></h3>"
           else
               do while not rec.EOF 
              response.write "<h3>" & rec.Fields(1) & "</h3>"
              response.write "<img src='"& rec.Fields(2) &"' width=91 height=99 Title='" & rec.Fields(1) & "' alt='"& rec.fields(1) &"' class=left />"
    ...
    <div class="clear"></div>
    <div id="footer"> &nbsp;
      Best View on Mozilla FireFox at 1024X786 resolution.
      <!-- end footnav -->
    </div>
    <!-- end footer -->
  </div>
