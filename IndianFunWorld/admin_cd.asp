...
<div id="wrapper">
  ...
  <li><a href="admin_cd.asp">Category +</a>
    <ul>
      <li><a href="admin_cd.asp">CD+</a>
        <ul>
  ...
  <div id="inner">
    <div id="body">
      ...
      dim query
       ...
       rec.open query,conn
       if rec.EOF then
             response.write"<h3>Nothing in Disc Stock<br><br><a href=admin.asp>Click Here to Return on Administration Tools</a></h3>"
             response.write"<br><br><br><br><br><br><br><br><br><br><br>"
       Else
             response.write"<form method=post action=edit_disc.asp><table border=2><tr>"
             ...
             response.write"<td><h3>Edit</h3></td>"
             ...
             do while not rec.EOF
                  ...
                  response.write"<td><h3>"& rec.Fields(6) &"</h3></td>"
                  response.write"<td><input type=Submit name=action value=Edit></td>"
                  response.write"<td><input type=Submit name=action value=Delete></td></tr>"
                  rec.movenext
             loop
             response.write"</table><br><br>"
             response.write"<input type=Submit name=action value='Add Disc'>"
             response.write"</form>"
        End If
      %>
