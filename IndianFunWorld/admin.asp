...
<div id="wrapper">
  ...
  <li><a href="admin.asp">Category +</a>
    <ul>
      <li><a href="admin.asp">CD+</a>
        <ul>
...
<!-- end browse -->
  <div id="inner">
    <div id="body">
      <div class="inner">
<br><br>
      <h3><a href=admin_user.asp>View Detail/Remove User</a></h3>
      <h3><a href=admin_cd.asp>Add/Edit/Remove CD/DVD</a></h3>
      <h3><a href=admin_BuyedItem.asp>View Purchased CD/DVD</a></h3>
